...
// ulObject.innerHTML='<li id="first" class="firstanimation"><a href="#"><img src="images/img_1.jpg" alt="Cougar"></a><div class="tooltip"><h1>Cougar</h1></div></li>'


                   var str='';
                   for(i in sliderData.imageList){
                       str+='<li id="'+sliderData.imageList[1].itemId+'" class="'+sliderData.imageList[i].itemClassName+'">'+
